...
namespace DTO
{
    public class Doanhthuthang
    {
        ...
        public Doanhthuthang(DateTime id_dtt, long tongtien_don_off, long tongtien_don_onl, long tongtien, long tienhang_daban, long tien_nhap, long chi_phi, long loi_nhuan)
        {
            this.id_dtt = id_dtt;
        ...
        public DateTime Id_dtt { get => id_dtt; set => id_dtt = value; }
